...
#Github :- B_R_A_N_D_E_D_K_I_N_G  | BRANDED_KHUSHI
import requests
import random
import os
import re
...
API_HASH = os.environ.get("129b292dc07c43347e3255c09e0a3e49") 
BOT_TOKEN = os.environ.get("6137836765:AAGqLgNyR7NE2K2IWAUX6itcEb9zq9q6g_0") 
...
UPDATE_CHNL = os.environ.get("BRANDED_KHUSHI")
OWNER_ID = os.environ.get("6258877205")
OWNER_USERNAME = os.environ.get("BRANDRD_21")
SUPPORT_GRP = os.environ.get("BRANDED_LINK")
BOT_NAME = os.environ.get("Lokesh x khushi")
...
async def cb_handler(Client, query: CallbackQuery):
    lokeshkhushi = MongoClient(MONGO_URL)
    lokeshkhushi = lokeshkhushi["lokeshkhushiDb"]["lokeshkhushi"]
    if query.data == "HELP":
...
async def get_st(_, msg: Message):
    ...
    await msg.reply_photo(photo="https://te.legra.ph/file/6a4ac076ff159bdcf9656.jpg",
...
print(f"{BOT_NAME} ɪs ᴀʟɪᴠᴇ! ɴᴏᴡ ғᴜᴄᴋ ᴏғғ! ᴀɴᴅ ɢᴏ ᴛᴏ @BRANDED_WORLD!!")      
bot.run()
